...
public class TextController : MonoBehaviour {
    ...
    void in_closet()
    {
        texto.text = "Inside the closet you see a cleaner's uniform that looks about your size! " +
    ...
    void closet_door()
    {
        texto.text = "You are looking at a closet door, unfortunately it's locked. " +
    ...
    void corridor_3()
    {
        texto.text = "You're standing back in the corridor, now convincingly dressed as a cleaner. " +
    ...
    void corridor_2()
    {
        texto.text = "Back in the corridor, having declined to dress-up as a cleaner.\n\n" +
    ...
    void corridor_1()
    {
        texto.text = "Still in the corridor. Floor still dirty. Hairclip in hand. " +
    ...
    void floor()
    {
        texto.text = "Rummagaing around on the dirty floor, you find a hairclip.\n\n" +
    ...
    void courtyard()
    {
        texto.text = "You walk through the courtyard dressed as a cleaner. " +
    ...
    void stairs_0()
    {
        texto.text = "You start walking up the stairs towards the outside light. " +
    ...
    void stairs_1()
    {
        texto.text = "Unfortunately weilding a puny hairclip hasn't given you the " +
    ...
    void stairs_2()
    {
        texto.text = "You feel smug for picking the closet door open, and are still armed with " +
    ...
    void cell() {
        texto.text = "You are in a prison cell, and you want to escape. There are " +
    ...
    void mirror()
    {
        texto.text = "The dirty old mirror on the wall seems loose.\n\n" +
    ...
    void cell_mirror()
    {
        texto.text = "You are still in your cell, and you STILL want to escape! There are "+
    ...
    void sheets_0()
    {
        texto.text = "You can't believe you sleep in these things. Surely it's " +
    ...
    void sheets_1()
    {
        texto.text = "Holding a mirror in your hand doesn't make the sheets look " +
                     "any better.\n\n" +
                     "Press R to Return to roaming your cell";
    ...
    void lock_0()
    {
        texto.text = "This is one of those button locks. You have no idea what the " +
    ...
    void lock_1()
    {
        texto.text = "You carefully put the mirror through the bars, and turn it round " +
                     "so you can see the lock. You can just make out fingerprints around " +
                     "the buttons. You press the dirty buttons, and hear a click.\n\n" +
                     "Press O to Open, or R Return to your cell";
    ...
    void corridor_0()
    {
        texto.text = "You're out of your cell, but not out of trouble." +
